...
public class Date
{
  ...
  public Date addDay()
  {
    ...
    {
      //Day must have been the last one in the month.
      //Try the next month.
      try { return new Date(1, month + 1, year); }
      catch (Exception exception2)
      {
        //Month must have been 12.
        //Try the first of the next year.
  ...
  public Date addMonth()
  {
    ...
    {
      //Month must have been 12.
      //Try the first one of the next year.
      try { return new Date(day, 1, year + 1); }
      catch (Exception exception2)
      {
        //The new month may not have as many days.
        //Try the last day of the new month.
        //This cannot cause an exception.
        try { return new Date(daysInMonth(), month + 1, year); }
        catch (Exception exception3) { return null; }
      } //catch
    } //catch
  } // addMonth
  ...
  public Date addYear()
  {
    ...
    {
      //Day must have been 29 and month must have been 2.
      //Try changing the day to 28.
      //This cannot cause an exception.
      try { return new Date(28, month, year + 1); }
      catch (Exception exception2) { return null; }
    } //catch
  } // addYear
  ...
  public Date subtractDay() throws Exception
  {
    ...
    {
      //Day must have been the first one in the month.
      //Try the past month.
      try { return new Date(daysInMonth(month - 1, year), month - 1, year); }
      catch (Exception exception2)
      {
        //Month must have been 1.
        //Try the last of the past year.
        //This cannot cause an exception.
  ...
  public Date subtractMonth() throws Exception
  {
    ...
    {
      //Month must have been 1.
      //Try the last one of the past year.
